...
const Home = () => {
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-4 items-center justify-center h-full px-4 md:flex-row">
        ...
        <div>
          <img
            src={heroImg}
            alt="Profile_pic"
            className="rounded-2xl mx-auto w-max_width md:w-full"
          />
        </div>
      </div>
    </div>
